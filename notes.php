                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-11 col-md-12">
                                <div class="hero__caption hero__caption2">
                                    <h1 data-animation="bounceIn" data-delay="0.2s">Resources</h1>
                                    <!-- breadcrumb Start-->
...
{               ?>
                        ...
                        <div class="properties properties2 mb-30">
                            <div class="properties__card">
                                <div class="properties__img overlay1">
                                    <a href="#"><img src="assets/img/book.jpg" width="300" height="300" alt=""></a>
                                </div>
                                <div class="properties__caption">
                                    ...
                                    <p><table border="1"><tr>
  <th width="200"><strong><?php  echo htmlentities($row->filename1);?></strong></th>
  ...
  <?php if($row->File2==""){ ?>
    <tr>
  <th width="200"><strong><?php  echo htmlentities($row->filename2);?></strong></th>
  ...
  <?php if($row->File3==""){ ?>
    <tr>
  <th width="200"><strong><?php  echo htmlentities($row->filename3);?></strong></th>
  <td colspan="3" style="text-align: center;"><strong style="color: red">File is not available</strong></td>
  ...
  <?php if($row->File4==""){ ?>
    <tr>
  <th width="200"><strong><?php  echo htmlentities($row->filename4);?></strong></th>
  <td colspan="3" style="text-align: center;"><strong style="color: red">File is not available</strong></td>
...
<?php if($row->File4==""){ ?>
    <tr>
  <th width="200"><strong><?php  echo htmlentities($row->filename5);?></strong></th>
  <td colspan="3" style="text-align: center;"><strong style="color: red">File is not available</strong></td>
  
  </tr><?php } else{?>
  <tr>
  <th width="200"><strong><?php  echo htmlentities($row->filename5);?></strong></th>
  <td colspan="3" style="text-align: center;"><a href="user/folder5/<?php echo $row->File5;?>" width="100" height="100" target="_blank" class="btn bnt-primary">Download File</a></td></tr><?php } ?>
</p></table>
                                </div>
