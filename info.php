...
engaged and share
responsibility for developing life-long learnersCore values
 Maka-Diyos
 Maka-tao
 Makalikasan
 Makabansa
DepEd Region IV-Calabarzon is the region where EXCELLENCEis a culture and
QUALITY is a commitment</pre></div></div></div></div>
</div></div></div>
