...
<table id="chat_room" style="background-color: yellow;">
	<tr>
	...
	?>
			...
			<tr>
				...
				<form class="form" action="home.php" >
					...
					<button type="button" id="send_msg" class="button button2">Send</button><button type="button" class="btn cancel" onclick="closeForm()">Close</button>
				</form>
				</td>
			</tr>
