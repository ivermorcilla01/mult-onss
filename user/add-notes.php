...
$extension5 = substr($file5,strlen($file5)-4,strlen($file5));
...
// }
    ...
    if($file5!=''):
    $file5=md5($file).time().$extension5; endif;
 ...
 move_uploaded_file($_FILES["file2"]["tmp_name"],"folder2/".$file2);
  move_uploaded_file($_FILES["file3"]["tmp_name"],"folder3/".$file3);
   ...
   move_uploaded_file($_FILES["file5"]["tmp_name"],"folder5/".$file5);

$sql="insert into tblnotes(UserID,Subject,NotesTitle,NotesDecription,File1,File2,File3,File4,File5,filename1,filename2,filename3,filename4,filename5)values(:ocasuid,:subject,:notestitle,:notesdesc,:file1,:file2,:file3,:file4,:file5,:filename1,:filename2,:filename3,:filename4,:filename5)";
...
$query->bindParam(':file5',$file5,PDO::PARAM_STR);
                        ...
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control"  name="notesdesc" value=""></textarea>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">filename1</label>
                                    <input type="text" class="form-control"  name="filename1" value="" >
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="filename2" value="" >
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="filename3" value="" >
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">More File</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="filename4" value="" >
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">More File</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="filename5" value="" >
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">More File</label>
                                   <input type="file" class="form-control"  name="file5" value="" >
