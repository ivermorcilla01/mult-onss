...
$extension2 = substr($file5,strlen($file5)-4,strlen($file5));
...
$file5=md5($file).time().$extension1;
  move_uploaded_file($_FILES["file5"]["tmp_name"],"folder4/".$file5);
$sql="update tblnotes set file5=:file5 where ID=:eid";
$query=$dbh->prepare($sql);

$query->bindParam(':file4',$file5,PDO::PARAM_STR);
...
{               ?>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control"  name="filename5" value="<?php  echo htmlentities($row->filename5);?>" readonly='true'>

                                    
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">View Old file5</label>
                                   <a href="folder5/<?php echo $row->file5;?>" width="100" height="100" target="_blank"> <strong style="color: red">View Old File</strong></a>
...
$file5=md5($file).time().$extension1;
  move_uploaded_file($_FILES["file4"]["tmp_name"],"folder5/".$file5);
$sql="update tblnotes set file5=:file5 where ID=:eid";
$query=$dbh->prepare($sql);
...
{               ?>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail2" class="form-label">View Old file5</label>
                                   <a href="folder4/<?php echo $row->file5;?>" width="100" height="100" target="_blank"> <strong style="color: red">View Old File</strong></a>
