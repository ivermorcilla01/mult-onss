...
{               ?>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                     ...
                     <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-file me-2"></i>Calendar</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="index.php" class="dropdown-item">Add Calendar</a>
                     ...
                     <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-file me-2"></i>Enroll</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="manage-students.php" class="dropdown-item">STUDENT</a>
